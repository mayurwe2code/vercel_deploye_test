...
// data1.forEach((item, index) => {
//     console.log(index)
//     if (product_chk_ar.includes(item["product_id"])) {
//         formate_data[item["product_id"]]["verients"].push(item)
//     } else {
//         // item["verients"] = []
//         product_chk_ar.push(item["product_id"])
//         var obj = { verients: [] };
//         obj[item["product_id"]] = item//only_product_key_bhejna he
//         // obj[item["product_id"]]["verients"] = []
//         obj[item["product_id"]].verients.push(item)
//         formate_data.push(obj)
//     }
//     if (data1.length - 1 == index) { console.log(formate_data) }
// });
...
// product.id,
//     product.name,
//     GROUP_CONCAT(product_verient.product_verient_id) AS verients
// FROM product
// LEFT JOIN product_verient ON product.id = product_verient.product_id
// GROUP BY product.id;
